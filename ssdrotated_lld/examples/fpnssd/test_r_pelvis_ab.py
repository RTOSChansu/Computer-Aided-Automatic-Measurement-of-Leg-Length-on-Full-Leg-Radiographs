...
DATA_LIST_PATH = 'png'
#RESTORE_FROM = './examples/fpnssd/models/models_r_pelvis_ab/r_pelvis_ab_model.pth'
RESTORE_FROM = './examples/fpnssd/models/models_r_pelvis_ab/new.pth'

def segmentation_r_pelvis_ab(name):
    try:
        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/right_pelvis_abnormal/'
        ...
        save_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/outputs_r_pelvis'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_pelvis_abnormal/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            npy = int(miny) + h_w * py
            f.close()
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_pelvis_abnormal/coordinate_point.txt'
            f1 = open(c_path1, 'w')
            ...
            px_ = []
            py_ = []
            for i in range(int(px),int(0.66*rgb.size[1]),1):
            ...
            for i in range(len(rpx_)-3,0,-1):
                ...
                elif curvature > 0.15 and curvature < 0.62:
            ...
            if tmp is 0:
                for i in range(rgb.size[1]-1,0,-1):
                    for j in range(rgb.size[1]-1,lpx,-1):
                        if pixels[j,i] == (255,255,255):
                            s_px = j
                            s_py = i
            else:
                for i in range(rgb.size[1]-1,0,-1):
                    for j in range(rgb.size[1]-1,tmpx,-1):
                        if pixels[j,i] == (255,255,255):
                            s_px = j
                            s_py = i  
