...
DATA_LIST_PATH = 'png'
RESTORE_FROM = './examples/fpnssd/models/models_l_ankle/l_ankle_model.pth'

def segmentation_l_ankle(name):
    try:
        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/left_ankle/'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_ankle/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            f.close()
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_ankle/coordinate_point.txt'
            f1 = open(c_path1, 'w')
