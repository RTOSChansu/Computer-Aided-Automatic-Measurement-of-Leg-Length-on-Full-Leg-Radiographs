...
DATA_LIST_PATH = 'png'
RESTORE_FROM = './examples/fpnssd/models/models_r_pelvis/new.pth'
#RESTORE_FROM = './examples/fpnssd/models/models_r_pelvis/r_pelvis_model.pth'

def segmentation_r_pelvis(name):
    try:

        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/right_pelvis/'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_pelvis/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            npy = int(miny) + h_w * py
            f.close()
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_pelvis/coordinate_point.txt'
            f1 = open(c_path1, 'w')
