...
DATA_DIRECTORY = './examples/fpnssd/demo/result/'
DATA_LIST_PATH = 'png'
RESTORE_FROM = './examples/fpnssd/models/models_l_pelvis/new.pth'
#RESTORE_FROM = './examples/fpnssd/models/models_l_pelvis/l_pelvis_model.pth'

def segmentation_l_pelvis(name):
    try:
        DATA_DIRECTORY = './examples/fpnssd/demo/result/' + name + '/left_pelvis/'
        ...
        save_path = './examples/fpnssd/demo/result/'+name+'/outputs_l_pelvis'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_pelvis/coordinate.txt'
            ...
            npy = int(miny) + h_w * py
            f.close()
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_pelvis/coordinate_point.txt'
            f1 = open(c_path1, 'w')
