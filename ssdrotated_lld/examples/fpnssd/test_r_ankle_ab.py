...
DATA_LIST_PATH = 'png'
RESTORE_FROM = './examples/fpnssd/models/models_r_ankle_ab/r_ankle_ab_model.pth'

def segmentation_r_ankle_ab(name):
    try:
        
        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/right_ankle_abnormal/'
        ...
        save_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/outputs_r_ankle'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_ankle_abnormal/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            f.close()
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/right_ankle_abnormal/coordinate_point.txt'
            f1 = open(c_path1, 'w')
