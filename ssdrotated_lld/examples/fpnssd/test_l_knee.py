...
def segmentation_l_knee(name):
    try:

        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/left_knee/'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_knee/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_knee/coordinate_point.txt'
            f1 = open(c_path1, 'w')
            px = int(minx) + w_w * point_x
            py = int(miny) + h_w * point_y
            f1.write(str(int(px)))
            f1.write(",")
            f1.write(str(int(py)))
            f1.close()
