...
DATA_LIST_PATH = 'png'
RESTORE_FROM = './examples/fpnssd/models/models_knee/knee_ab_model.pth'


def segmentation_l_knee_ab(name):
    try:

        DATA_DIRECTORY = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/left_knee_abnormal/'
        ...
        save_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/' + name + '/outputs_l_knee'
        ...
        for index, batch in enumerate(testloader):
            ...
            c_path = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_knee_abnormal/coordinate.txt'
            f = open(c_path, 'r')
            line = f.read()
            minx = line.split(',')[0]
            miny = line.split(',')[1]
            ...
            c_path1 = '/home/sonic/lld/ssdrotated_lld/examples/fpnssd/demo/result/'+name+'/left_knee_abnormal/coordinate_point.txt'
            f1 = open(c_path1, 'w')
            nrx = int(minx) + w_w * point_x
            nry = int(miny) + h_w * point_y
            f1.write(str(int(nrx)))
            f1.write(",")
            f1.write(str(int(nry)))
            f1.write("\n")
            f1.close()
